-- ============================================================
-- Custom Orders DB Schema Setup
-- Save this file as customordersql.sql in the project root.
-- ============================================================

-- 1. Create a dedicated table for custom order requests
...
-- 2. Indexes for seller/customer lookups and status filters
